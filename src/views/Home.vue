<template>
  <div class="home">
    <button class="create" @click="createNote">Перейти к созданию новой заметки</button>
      ...
      <div class="todo">
        <ul>
          <li v-for="todo in note.todo">
            <a :class="{'cross-text':todo.done}">{{todo.text}}</a>
          </li>
        </ul>
      </div>
      <div class="buttons">
        ...
        <button class="delete" @click="openModal(index)">Удалить (необходимо подтверждение)</button>
      </div>
    </div>
